...
# Trust the workspace directory so Codex skips the confirmation prompt
mkdir -p "${HOME}/.codex"
cat > "${HOME}/.codex/config.toml" <<TOML
# Auto-generated by Home Assistant Codex add-on
...
"${WORKSPACE}" = true
TOML
echo "[INFO] Workspace ${WORKSPACE} marked as trusted for Codex"
